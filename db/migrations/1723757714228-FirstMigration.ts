...
export class FirstMigration1723757714228 implements MigrationInterface {
    name = 'FirstMigration1723757714228'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "plans" ("planName" character varying NOT NULL, "price" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_af9011aa81d61b640123dcf16bd" PRIMARY KEY ("planName"))`);
