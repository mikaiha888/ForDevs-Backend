...
export class First1724683040069 implements MigrationInterface {
    name = 'First1724683040069'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "plans" ("name" character varying NOT NULL DEFAULT 'Free', "price" double precision NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_253d25dae4c94ee913bc5ec4850" PRIMARY KEY ("name"))`);
